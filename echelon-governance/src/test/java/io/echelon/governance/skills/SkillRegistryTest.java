...
class SkillRegistryTest {
  ...
  @Test
  void testDiscover() {
    when(skillRepository.findByCategory("reviewing")).thenReturn(List.of(reviewSkill));
  ...
  @Test
  void testFindByName() {
    when(skillRepository.findAll()).thenReturn(List.of(reviewSkill, buildSkill));
  ...
  void testFindByNameReturnsEmptyWhenNotFound() {
    when(skillRepository.findAll()).thenReturn(List.of(reviewSkill));
