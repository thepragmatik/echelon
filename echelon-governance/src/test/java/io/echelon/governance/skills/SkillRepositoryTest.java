...
class SkillRepositoryTest {
  ...
  void testSaveAndFindById() {
    when(hashOps.entries("skills:review-github-pr@1.0.0")).thenReturn(reviewSkill.toMap());
  ...
  void testFindAll() {
    ...
    when(hashOps.entries("skills:review-github-pr@1.0.0")).thenReturn(reviewSkill.toMap());
    when(hashOps.entries("skills:build-from-issue@1.0.0")).thenReturn(buildSkill.toMap());
    when(hashOps.entries("skills:scan-secrets@1.0.0")).thenReturn(securitySkill.toMap());
    ...
    assertTrue(
        ids.containsAll(
            List.of("review-github-pr@1.0.0", "build-from-issue@1.0.0", "scan-secrets@1.0.0")));
  }
  ...
  void testFindAllFiltersIndexKeys() {
    ...
    when(hashOps.entries("skills:review-github-pr@1.0.0")).thenReturn(reviewSkill.toMap());
    when(hashOps.entries("skills:by-category:reviewing")).thenReturn(Map.of());
    when(hashOps.entries("skills:all")).thenReturn(Map.of());
  ...
  void testDelete() {
    ...
    when(hashOps.entries("skills:review-github-pr@1.0.0")).thenReturn(skillData);
