...
class DeonticTokenTest {
  ...
  void permitRecordHasCorrectFields() {
    ...
    var permit =
        new DeonticToken.Permit(
            "write_source", Set.of("implementer"), "echelon-core", "test permit", now);
  ...
  void embargoRecordHasCorrectFields() {
    var embargo =
        new DeonticToken.Embargo(
            "write_to_main", Set.of("implementer"), "echelon-core", "test embargo", Instant.now());
  ...
  void evaluationResultAllowCreated() {
    var token =
        new DeonticToken.Permit(
            "write_source", Set.of("implementer"), "core", "test", Instant.now());
  ...
  void evaluationResultDenyCreated() {
    var token =
        new DeonticToken.Embargo(
            "write_to_main", Set.of("implementer"), "core", "test", Instant.now());
