...
class BudgetManagerTest {
    ...
    void deductRespectsMonthlyAgentCap() {
        ...
        assertTrue(budgetManager.deduct("task-new", "agent-1", "project-1", 19999));  // agentUsed=480000, 480000+19999=499999 < 500000
        assertFalse(budgetManager.deduct("task-new2", "agent-1", "project-1", 20001)); // 480000+20001=500001 > 500000
    }
}
