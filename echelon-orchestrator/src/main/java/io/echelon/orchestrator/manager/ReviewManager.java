...
public class ReviewManager {
  ...
  private static final String CONSUMER =
      "review-mgr-" + UUID.randomUUID().toString().substring(0, 8);
  ...
  void processReview(MapRecord<String, Object, Object> record) {
    ...
    if (allApproved) {
      ...
      audit.log(
          "review_approved", Map.of("taskId", taskId, "verdicts", String.join(",", verdicts)));
